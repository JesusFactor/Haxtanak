...
class Ogostos11 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        button2.setOnClickListener {
            startActivity(Intent(Intent.ACTION_VIEW, Uri.parse("https://www.bible.com/ru/bible/2329/1TI.5.ՆՎԱԱ")))
        }

        button3.setOnClickListener {
            startActivity(Intent(Intent.ACTION_VIEW, Uri.parse("https://www.bible.com/ru/bible/2329/ISA.35.ՆՎԱԱ")))
        }
    }
