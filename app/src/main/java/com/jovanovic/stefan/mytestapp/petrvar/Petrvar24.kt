...
class Petrvar24 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        button2.setOnClickListener {
            startActivity(Intent(Intent.ACTION_VIEW, Uri.parse("https://www.bible.com/ru/bible/2329/ACT.27.ՆՎԱԱ")))
        }

        button3.setOnClickListener {
            startActivity(Intent(Intent.ACTION_VIEW, Uri.parse("https://www.bible.com/ru/bible/2329/LEV.20.ՆՎԱԱ")))
        }
    }
