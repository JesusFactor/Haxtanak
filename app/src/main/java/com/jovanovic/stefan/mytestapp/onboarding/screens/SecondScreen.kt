...
class SecondScreen : Fragment() {
    ...
    override fun onCreateView(
        ...
        val next2 = view.findViewById<TextView>(R.id.next2) as TextView
        val hand = view.findViewById<ImageView>(R.id.hand) as ImageView
        ...
        next2.startAnimation(btb)
        hand.startAnimation(blind)
        ...
        val descs = listOf("Եկեղեցում մենք արտահայտում ենք մեր սերն Աստծո, ինչպես նաև մերձավորի նկատմամբ:", "Աստծո սերը հիմքն է մեր ողջ ծառայության համար, երբ մենք օգնում և ծառայում ենք միմյանց, երբ մենք տարածում ենք Ավետարանը և ծառայում ենք հասարակությանը մեր շուրջը:\n", "Եկեղեցին միասնության վայր է, որում ամեն մեկը հավասարապես արժեքավոր է Աստծո համար:", "Եկեղեցին ընտանիք է, որը կազմված է ամենատարբեր ազգություններից և էթնիկ խմբերից:", "Եկեղեցին ընտանիք է, որը բաղկացած է տարբեր տարիքի և սերունդների մարդկանցից:")
        var clickCount = 0
        view.imageView2.setOnClickListener {
            if (clickCount >= 3){
                viewPager?.currentItem = 2
            }else{
                next2.startAnimation(stb)
                next3.startAnimation(stb)
                //view.imageView2.startAnimation(fade)
